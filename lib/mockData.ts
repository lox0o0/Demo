...
export const TIERS = [
  ...
  { name: "Silver", minPoints: 1000, color: "#C0C0C0", reward: "Meet the team - Broncos training access with one mate", access: "Meet the team - Broncos training access with one mate" },
