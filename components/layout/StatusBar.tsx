  ...
  return (
    <div className="sticky top-0 z-40 flex items-center justify-center px-6 py-4">
      ...
      >
        ...
        {teamData && (
          <div className="relative w-12 h-12 rounded-lg border-2 border-white/30 overflow-hidden bg-white/5 backdrop-blur-sm flex items-center justify-center flex-shrink-0">
            <Image
        ...
        <div className="flex flex-col items-center gap-2 flex-1 min-w-0">
          {/* Progress Bar Track */}
          <div className="w-full relative bg-gray-700/50 rounded-full h-4 overflow-hidden border border-gray-600/50">
          ...
          {/* Points to Tier Text */}
          <div className="text-xs text-white/80 text-center whitespace-nowrap">
            {pointsToNext > 0 ? (
